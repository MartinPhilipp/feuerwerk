...
class Energyshield(VectorSprite):
    ...
    def create_image(self):
        ...
        if self.age < self.last_blink:
            ...
            t = self.hitpoints//70
            t = max(t,1)
        pygame.draw.circle(self.image, c, (self.radius,self.radius),self.radius,int(t))
        self.image.set_colorkey((0,0,0))
        self.rect= self.image.get_rect()
        self.image.convert_alpha()
        self.image0 = self.image.copy()
    ...
    def update(self, seconds):
        ...
        if self.hitpoints < self.hitpoints_full:
            if self.age < self.peace:
                i = Viewer.current_level["Energyshieldrepair"]
                repair = Viewer.item_level["Energyshieldrepair"][i]
                self.hitpoints += repair#*seconds
...
class Viewer(object):
    ...
    menu =  {"main":     ["Resume", "Shop", "Help", "Credits", "Settings",],
            "Shop":      ["back", "Cannon range", "Tracer damage", "Missle speed", "Energyshieldrepair", "Turretrepair"],
    ...
    descr = {"Resume" :           ["Resume to the", "game"],                                           #resume
             ...
             "Energyshieldrepair":["Increase the", "regenerationspeed", "of your energyshields"],
             ...
             "Turretrepair":      ["Increase the", "regenerationspeed", "of your turrets"],
             }
    ...
    item_level = {"Cannon range" : [100,200,300,500,600],
                  ...
                  "Energyshieldrepair" : [0.5,1,3,5,15],
                  "Turretrepair" :  [0.5,1,3,5,15],
                  "Tracer damage" : [100, 3, 5,20,50]}
    item_cost = {"Cannon range" : [100,250,400,550, 700],
                 "Missle speed" : [50,100,200,300,500],
                 "Energyshieldrepair" : [50,100,200,400,600],
                 "Turretrepair" :  [50,100,200,400,600],
                 "Tracer damage" : [100, 200, 300,400,500]}
    items = ["resume", "Cannon range", "Tracer damage","Missle speed", "Energyshieldrepair", "Turretrepair"]
    history = ["main"]
    cursor = 0
    name = "main"
    fullscreen = False
        ...
        while running:
            ...
            for t in self.turretgroup:
                if t.pos.y < t.y_full and t.age > t.peace:
                    i = Viewer.current_level["Turretrepair"]
                    repair = Viewer.item_level["Turretrepair"][i]
                    print(seconds)
